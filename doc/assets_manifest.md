...
| `rhetor_rhetor.png` `rhetor_senator.png` `rhetor_causidicus.png` `rhetor_philosophus.png` `rhetor_censor.png` `rhetor_grammaticus.png` `rhetor_poeta.png` `rhetor_matrona.png` `rhetor_sophista.png` `rhetor_iurisconsultus.png` | 480×540 | oui | bas-centre | orateurs adverses | Rhéteur grec (chiton bleu, rouleau), sénateur âgé (toge, bâton), avocat rusé (manteau vert, tablette), philosophe stoïcien (chauve, barbe, bâton), censeur (toge pourpre, faisceaux) ; grammairien (manteau brun, tablette, barbe grisonnante), poète (toge parchemin à liséré rouge, laurier, rouleau), matrone érudite (palla rouge à liséré d'or, lettre), sophiste (chiton pâle à liséré bleu, chauve, deux mains ouvertes), jurisconsulte (toge à bande cramoisie, tablette, cheveux gris). Générés par `python3 tool/assets/generate_forum_art.py [nom…]`. |
