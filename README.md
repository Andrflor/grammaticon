...
* **Pas de mode d'entraînement** : chaque rencontre se joue pour de vrai, avec gemmes et cœurs. La première rencontre avec une notion se fait avec l'*Auxilium* (réponse aidée : petit gain, aucune perte).
...
* **Tabula** : maîtrise estimée par compétence, alimentée par les réponses réelles (nombre, diversité des verbes, réussite récente au premier essai, dernière pratique, fiabilité). **La maîtrise recule avec l'absence** : au-delà du délai de son palier (2 jours en discēns, 5 en familiāris, 14 en perīta), l'estimation perd 2 points par jour sans pratique, la barre raccourcit et change de couleur en franchissant les seuils (vert → orange sous 85 %, orange → bleu sous 60 %), jusqu'à zéro. Rien n'est stocké : le recul se calcule à la lecture depuis la dernière pratique, et la réponse suivante repart de l'estimation reculée. Aucune autre indication : la barre seule porte l'information. Branche **Dēclīnātiōnēs** : déclinaison → cas → nombre, locatif, épreuves mixtes. Branche **Lēctiō · Theātrum** : verbe en phrase (nombre, personne, temps, mode, voix), nom en phrase (cas, accord), formes nominales, mélanges — distincte des arbres de reconnaissance des formes.
