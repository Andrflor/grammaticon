...
class StrikeScene extends EncounterScene {
  ...
  void playerStrikes() {
    ...
    Future<void>.delayed(Duration(milliseconds: 150), () {
      ...
      _sparks(
        enemy.position - Vector2(0, enemy.size.y * 0.5),
        skin.paint('FFFFE08A'),
        18,
      );
    });
  ...
  void opponentStrikes() {
    ...
    Future<void>.delayed(Duration(milliseconds: 170), () {
      ...
      _sparks(
        hero.position - Vector2(0, hero.size.y * 0.5),
        skin.paint('FFE0333F'),
        10,
      );
    });
  ...
  void _impact(Vector2 at, {double scaleMul = 1}) {
    ...
    c.add(
      OpacityEffect.fadeOut(EffectController(duration: 0.3, startDelay: 0.08)),
    );
