...
class Trials {
  ...
  static final List<Trial> all = List.unmodifiable([..._build(), ...ForumTrials.build(), ...FrameTrials.build()]);
  ...
  static List<Trial> _build() => [
        ...
        Trial(
          ...
          dimensions: const [Dimension.tempus, Dimension.modus, Dimension.vox, Dimension.persona, Dimension.numerus, Dimension.lemma, Dimension.voxSensus],
        ...
        Trial(
          ...
          dimensions: const [Dimension.tempus, Dimension.modus, Dimension.persona, Dimension.numerus, Dimension.coniugatio, Dimension.lemma, Dimension.vox, Dimension.voxSensus],
        ...
        Trial(
          ...
          dimensions: const [Dimension.tempus, Dimension.modus, Dimension.persona, Dimension.numerus, Dimension.lemma, Dimension.vox, Dimension.voxSensus],
        ...
        Trial(
          ...
          dimensions: const [Dimension.vox, Dimension.tempus, Dimension.persona, Dimension.numerus, Dimension.voxSensus],
          components: const [
