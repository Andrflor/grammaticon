...
export '../arbor/needs.dart' show ArborNeeds;
...
class QuestionSources implements QuestionSource {
  ...
  Question? generate({
    ...
    ArborNeeds? needs,
      ...
      forTrial(trial).generate(trial: trial, componentIds: componentIds, rng: rng, id: id, recentLemmas: recentLemmas, recentSurfaces: recentSurfaces, skills: skills, cfg: cfg, exposure: exposure, recall: recall, needs: needs);
