  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      body: Container(
        ...
        child: Column(
          children: [
            TopBar(title: config.labels.title, gems: save.gems),
            Expanded(
              child: ContentColumn(
                maxWidth: 1480,
                child: ListView(
                  ...
                  children: [
                    RomanPanel(
                      ...
                      child: Row(
                        children: [
                          Image.asset(config.heroAsset, height: 56),
                          const SizedBox(width: 12),
                          Expanded(
                            child: Text(config.labels.blurb, style: G.body(14, color: G.goldLight, weight: 700)),
                          ),
                        ],
                      ),
                    ),
                      ...
                      LayoutBuilder(
                        builder: (context, c) {
                          ...
                          return Wrap(
                            ...
                            runSpacing: 14,
                            children: [
                              for (final t in trials.where((t) => t.group == g))
                                SizedBox(
                                  width: w,
                ...
                Positioned(
                  ...
                  child: Opacity(
                    ...
                    child: ColorFiltered(
                      ...
                      child: Image.asset(config.opponentAsset(trial.opponentId), width: 96, fit: BoxFit.contain, alignment: Alignment.bottomRight),
                    ),
                  ),
                ),
                Padding(
