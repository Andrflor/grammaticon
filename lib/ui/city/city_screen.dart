...
class _Building {
  const _Building({required this.id, required this.name, required this.activity, required this.asset, required this.x, required this.y, required this.width});
  final String id;
  final String name;
...
const _buildings = [
  _Building(id: 'templum', name: 'Templum', activity: 'Gallicē → Latīnē', asset: 'assets/images/bld_templum.png', x: 0.50, y: 0.42, width: 0.20),
...
class CityScreen extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    void open(_Building b) {
      ...
      pushScreen(context, switch (b.id) { 'forum' => const ForumScreen(), 'theatrum' => const TheatrumScreen(), 'templum' => const TrialSelectionScreen(activity: Activity.templum), _ => const ColiseumScreen() });
    }
