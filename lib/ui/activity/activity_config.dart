...
final ActivityConfig kTemplumConfig = ActivityConfig(
  activity: Activity.templum,
  labels: const ActivityLabels(
    title: 'Templum · Compositiō',
    blurb: 'Ēlige rītum.',
    encounter: 'Rītus',
    interrupted: 'Rītus interruptus',
    resume: 'Redī in templum',
    back: 'Redī in Templum',
    leaveTitle: 'Relinquere templum?',
    leaveBody: 'Rītus servātur: postea redīre poteris.',
    pausedBody: 'Rītus suspēnsus est.',
    victoryTitle: 'RĪTE!',
    victoryBody: 'Sacerdōs verba tua probat; dī tibi favent.',
    defeatTitle: 'RĪTUS VITIĀTUS',
    defeatBody: 'Sacerdōs verba tua reiēcit. Emptiōnēs et perītiae manent: iterum temptā!',
    gemsLine: 'Gemmae rītūs',
    penaltyLine: 'Tribūtum rītūs vitiātī',
    hits: 'verba',
    opponentResource: 'favor deōrum',
    wonTally: 'Rītūs perāctī',
    lostTally: 'vitiātī',
  ),
  heroAsset: 'assets/images/temple_hero_idle.png',
  startIcon: Icons.account_balance,
  opponentNames: const {'augur': 'Augur Vigil', 'flamen': 'Flāmen Diālis'},
  opponentAssetPrefix: 'temple_priest_',
  createScene: (trial, {required reducedMotion}) => TheatrumGame(opponentId: trial.opponentId, reducedMotion: reducedMotion, background: 'temple_bg', heroPrefix: 'temple_hero', opponentPrefix: 'temple_priest_'),
  showHelp: (context, ref, q, {required revealForm, note}) => showFrameHelpSheet(context, ref, q: q, revealForm: revealForm, note: note),
  correctCues: const [SoundCue(60, Sfx.tibia), SoundCue(320, Sfx.plausus)],
  wrongCues: const [SoundCue(120, Sfx.refutatio), SoundCue(340, Sfx.sibilus)],
  longText: true,
...
ActivityConfig configFor(Activity a) => switch (a) {
      ...
      Activity.templum => kTemplumConfig,
    };
