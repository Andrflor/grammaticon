...
final List<Skill> kSyntaxis = [
  ...
  _s('syn.abl.locus', 'Ablātīvus locī (ubi?)', 'Reconnaître le lieu où l\'on est : in/sub + abl. (in hortō est), et sans préposition avec locus, tōtus (tōtā urbe).', not: ['not.casus.abl'], parens: 'syn.abl', ag: ['§421', '§429'], req: ['n.des.a_long', 'n.des.o_long'],
  ...
  _s('syn.tempora.futex', 'Futūrum exāctum: anteriōritās in futūrō', 'Lire le futur antérieur comme achevé avant un futur (cum vēnerit, videbit).', not: ['not.tempus.futex'], parens: 'syn.tempora', ag: ['§478'], req: ['syn.tempora.imperf_perf', 'syn.tempora.praes_fut'],
